...
if sys.version_info[0] < 3:
    print("\nPython3 is needed to run CMSeeK, Try \"python3 scan.py\" instead\n")
    sys.exit(2)
...
print (" Input    Descrição")
print ("=======  ==============================")
print ("  [1]    Detecção de CMS e varredura profunda")
print ("  [2]    Verificar vários sites")
print ("  [3]    Varredura do Bruteforce")
print ("  [U]    Update scan")
